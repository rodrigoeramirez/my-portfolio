            ...
            <div className="w-full max-w-3xl mx-auto md:pb-40 md:pt-20">
                ...
                {dataAboutPage.map((data)=>(
                  <div key={data.id} className="relative py-6 pl-8 sm:pl-32 group">
                    <h3 className="mb-1 text-2xk font-bold sm:mb-0">{data.title}</h3>
                    <div className="flex flex-col sm_flex-row items-start mb-1 group-last_before:hidden before:absolute befora:left-2 sm:before:left-0 before:h-full before:px-px before_bg-slate-300 sm:before:ml-[6.5rem] before:self-start before:-translate-x-1/2 before:translate-y-3 after:w-2 after:h-2 after:bg-indigo-600 after:border-4 after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[6.5rem] after:-translate-x-1/2 after:translate-y-1.5flex flex-col sm:flex-row items-start mb-1 
